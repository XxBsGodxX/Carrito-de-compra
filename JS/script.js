...
// creo un vector auxiliar para modificar stock
 var productosCompra = []; 

//recorro tabla y escribo funcion que escribe toda la tabla en la pagina
...
//si se apretó de nuevo botón de compra en un mismo producto
...
//agrego datos a vector auxiliar de compra de productos

    agregarDatos(productos[idItem-1], input.value);

//con la estructura de datos anterior, llamo a funcion que dibuja la tabla 
...
//dibujo talba completa con elementos de productoCompra[]
...
function finCompra (){
    ...
    finalizar.innerHTML = "TOTAL: $"+sumaTotal +" gracias por su compra!"
}